...
export default function CartClient() {
  ...
  return (
    <div className="site-shell" style={{ padding: '60px 48px 100px' }}>
      ...
      {items.length === 0 ? (
        <div className="empty-cart" style={{ padding: '80px 40px', textAlign: 'center', background: theme.cream2, border: `1px solid ${theme.line}` }}>
        ...
        <div className="cart-layout" style={{ display: 'grid', gridTemplateColumns: '1.6fr 1fr', gap: 40 }}>
          <div>
            <OrderTracking />
            <div style={{ background: theme.cream2 }}>
              ...
              {items.map(it => (
                <div key={it.id} className="cart-item" style={{
                  ...
                  <div className="cart-item-image" style={{ aspectRatio: '1' }}>
                  ...
                  <div className="cart-item-main">
                    ...
                    <div className="cart-item-controls" style={{ display: 'flex', gap: 12, alignItems: 'center', marginTop: 8 }}>
                      <div className="cart-quantity" style={{ display: 'flex', alignItems: 'center', border: `1px solid ${theme.line}`, background: theme.cream }}>
                      ...
                      <button className="cart-remove" onClick={() => removeFromCart(it.id)} style={{
                  ...
                  <div className="cart-item-price" style={{ fontFamily: theme.serif, fontSize: 22, textAlign: 'right' }}>
